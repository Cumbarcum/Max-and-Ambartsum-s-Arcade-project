...
## 👥 Команда проекта
* **Максим (@MaximBal):** Разработка основной логики игры, физического движка, систем анимации и интеграция уровней.
* **Амбарцум (@Cumbarcum):** Работа с графикой, подбор и создание ассетов, визуальное оформление.
